...
# поскольку Memoization – это свойство функций сохранять (кешировать)
# результаты вычислений, дабы не вычислять в последствии повторно.
# Эта технология оптимизации позволят достичь прироста скорости работы за счет потерь в свободной памяти.
# и применительно к нашему примеру мемоизация не нужна, т.к. код выполняется один раз.
